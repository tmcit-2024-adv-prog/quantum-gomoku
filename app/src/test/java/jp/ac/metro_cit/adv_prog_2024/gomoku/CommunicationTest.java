...
public class CommunicationTest {
  ...
  void initReceiverWithNullAddress() {
    TransportSocketProps props = new TransportSocketProps(null, 5000, 5000);
  ...
  void callStartReceiveBeforeConnect() {
    TransportSocketProps props = new TransportSocketProps(null, 5001, 5001);
    TransportSocket socket = new TransportSocket(props);
  ...
  void callSendBeforeConnect() {
    TransportSocketProps props = new TransportSocketProps(null, 5002, 5002);
    TransportSocket socket = new TransportSocket(props);
  ...
  void initSender() {
    TransportSocketProps props = new TransportSocketProps(null, 5003, 5003);
    TransportSocket socket = new TransportSocket(props);
  ...
  void initReceiver() {
    TransportSocketProps props = new TransportSocketProps("127.0.0.1", 5004, 5004);
    TransportSocket socket = new TransportSocket(props);
  ...
  void initCommunication() throws InterruptedException {
    TransportSocketProps senderProps = new TransportSocketProps(null, 5005, 5005);
